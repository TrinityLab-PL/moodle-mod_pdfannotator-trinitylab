...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configcheckbox('mod_pdfannotator/enabledndforpdf',
            get_string('global_setting_enabledndforpdf', 'pdfannotator'),
            get_string('global_setting_enabledndforpdf_desc', 'pdfannotator'), 0));
