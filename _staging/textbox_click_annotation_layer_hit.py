#!/usr/bin/env python3
"""Textbox: hit-test tylko na warstwie adnotacji (annotationLayer.getIntersection),
żeby transformer z overlay nie przechwytywał kliknięć - każdy klik w textbox otwiera edycję."""
import os
...
# Stary blok: hit z stage, potem fallback po dzieciach.
...
# Nowy: hit wyłącznie na annotationLayer (bez overlay/transformer), potem resolve hitGroup w górę (wiele poziomów).
...
print('textbox_click_annotation_layer_hit: OK')
