...
$string['dnduploadpdfannotator'] = 'Add as PDF Edu activity';
...
$string['modulename'] = 'PDF Edu';
$string['modulename_help'] = 'PDF Edu by Trinity Lab enables collaborative markup on PDF documents. Users can annotate specific parts of a PDF and discuss them with other users.';
$string['modulename_link'] = 'mod/pdfannotator/view';
$string['modulenameplural'] = 'PDF Edu';
$string['month'] = 'month';
...
$string['pdfannotator:printcomments'] = 'Download the comments (even if the option is disabled for PDF Edu)';
$string['pdfannotator:printdocument'] = 'Download the document (even if the option is disabled for PDF Edu)';
...
$string['pdfannotator:usedrawing'] = 'Use drawing (even if the option is disabled for PDF Edu)';
$string['pdfannotator:usetextbox'] = 'Use textbox (even if the option is disabled for PDF Edu)';
$string['pdfannotator:view'] = 'View PDF Edu';
...
$string['pdfannotatorname'] = 'PDF Edu';
$string['pdfannotatorpost'] = 'Comments and questions';
$string['pdfButton'] = 'Document';
$string['pluginadministration'] = 'PDF Edu administration';
$string['pluginname'] = 'PDF Edu';
...
$string['global_setting_defaultfullscreen_desc'] = 'Default for new PDF Edu activities only. Per-activity settings still apply.';
$string['global_setting_enabledndforpdf'] = 'Show PDF Edu in drag-and-drop upload chooser';
$string['global_setting_enabledndforpdf_desc'] = 'When enabled, dropping a PDF onto a course page shows PDF Edu in the upload dialog. The teacher must choose PDF Edu manually; Resource remains the default selection.';
